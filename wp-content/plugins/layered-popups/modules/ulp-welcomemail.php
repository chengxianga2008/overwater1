...
class ulp_welcomemail_class {
				...
				<table class="ulp_useroptions">
					...
					<tr>
						...
						<td>
							...
							<br /><em>'.__('This e-mail message is sent to subscribers in case of successful subscription. You can use the following keywords: {name}, {e-mail}.', 'ulp').'</em>
						</td>
					</tr>
				</table>';
	}
	function popup_options_check($_errors) {
		...
		if (isset($_POST["ulp_welcomemail_enable"])) $popup_options['welcomemail_enable'] = "on";
