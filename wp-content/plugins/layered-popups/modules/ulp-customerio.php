...
class ulp_customerio_class {
	...
	function popup_options_check($_errors) {
		...
		if (isset($_POST["ulp_customerio_enable"])) $popup_options['customerio_enable'] = "on";
	...
	function popup_options_populate($_popup_options) {
		...
		if (is_array($_POST["ulp_customerio_attributes_name"]) && is_array($_POST["ulp_customerio_attributes_value"])) {
			$attributes = array();
			for($i=0; $i<sizeof($_POST["ulp_customerio_attributes_name"]); $i++) {
				$key = stripslashes(trim($_POST['ulp_customerio_attributes_name'][$i]));
				$value = stripslashes(trim($_POST['ulp_customerio_attributes_value'][$i]));
