...
class ulp_sendgrid_class {
	...
	function popup_options_check($_errors) {
		...
		if (isset($_POST["ulp_sendgrid_enable"])) $popup_options['sendgrid_enable'] = "on";
	...
	function popup_options_populate($_popup_options) {
		...
		if (is_array($_POST["ulp_sendgrid_fields_name"]) && is_array($_POST["ulp_sendgrid_fields_value"])) {
			$fields = array();
			for($i=0; $i<sizeof($_POST["ulp_sendgrid_fields_name"]); $i++) {
				$key = stripslashes(trim($_POST['ulp_sendgrid_fields_name'][$i]));
				$value = stripslashes(trim($_POST['ulp_sendgrid_fields_value'][$i]));
